...
export default function TopNavBar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0B1220]/90 backdrop-blur-md border-b border-outline-variant/30 h-16 w-full">
      <div className="max-w-[1440px] mx-auto px-6 md:px-margin-desktop h-full flex justify-between items-center">
        ...
        <button
          ...
          className="md:hidden text-white hover:text-primary focus:outline-none p-2"
      ...
      {/* Mobile Drawer */}
      <div
        className={`fixed inset-y-0 right-0 z-40 w-64 bg-[#0B1220] border-l border-outline-variant/30 shadow-2xl transform transition-transform duration-300 ease-in-out md:hidden flex flex-col justify-between p-6 ${
